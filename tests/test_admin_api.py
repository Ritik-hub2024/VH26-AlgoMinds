...
class TestAdminAPI(unittest.TestCase):
    ...
    def test_scan_auto_persists_to_admin(self):
        ...
        self.assertEqual(summary_data["summary"]["open_leaks"], 6)
        ...
        self.assertEqual(len(leak_proj["project"]["open_findings"]), 6)
    ...
    def test_phase_11_end_to_end_sequence(self):
        ...
        self.assertEqual(summary["open_leaks"], 6)
        ...
        self.assertEqual(persisted_summary["open_leaks"], 6)
